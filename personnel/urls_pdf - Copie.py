...
urlpatterns = [
    ...
    # Effectif détaillé par grade (nouvelle version)
    path('effectif-detaille-par-grade/pdf/', views_pdf_weasyprint.effectif_detaille_par_grade_pdf, name='effectif_detaille_par_grade_pdf'),
